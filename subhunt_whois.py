## This python script will initially create a pi-hole list.
##
##
## Install python3+
##
## Install requests
##
## Sign Up for a whoisxmlapi.com Account (free ones are available for infrequent users)
##
...
params = {"apiKey": apiKey, "domainName": domain}
